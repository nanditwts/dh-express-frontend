...
export const CourierListPage: React.FC = () => {
  const { couriers, addCourier, updateCourier, deleteCourier } = useCourierStore();
  ...
  const handleEditSubmit = (data: Record<string, any>) => {
    ...
    // Simulate API call
    setTimeout(() => {
      updateCourier(selectedCourier.id, data as any);
  ...
  const getChannelCount = (courierId: string) => {
        ...
        <Card>
          ...
          <Table
            columns={[
              ...
              { header: 'Channels', accessor: (item) => (
                <Badge variant="primary">
                  {getChannelCount(item.id)}
                </Badge>
              )},
